...
// For ESP32 Dev board
(only tested with ILI9341 display)
// The hardware SPI can be mapped to any pins

#define TFT_MISO 19
#define TFT_MOSI 23    // LCD_HR
#define TFT_SCLK 18    // LCD_RD
#define TFT_CS    5    // LCD_CS - Chip select control pin
#define TFT_DC   19    // LCD_RS - Data Command control pin
#define TFT_RST  21    // LCD_RST - Reset pin
